...
import 'package:flutter_datetime_picker/src/datetime_picker_theme.dart' as cus;
...
class _DatePickerRoute<T> extends PopupRoute<T> {
  _DatePickerRoute({
    ...
    BasePickerModel? pickerModel,
        ...
        this.theme = theme ?? cus.DatePickerTheme(),
  ...
  final cus.DatePickerTheme theme;
...
//    print('refreshScrollOffset ${widget.pickerModel.currentRightIndex()}');
  ...
  Widget build(BuildContext context) {
    cus.DatePickerTheme theme = widget.route.theme;
  ...
  Widget _renderPickerView(cus.DatePickerTheme theme) {
  ...
  Widget _renderItemView(cus.DatePickerTheme theme) {
    return Container(
      color: theme.backgroundColor,
  ...
  // Title View
  Widget _renderTitleActionsView(cus.DatePickerTheme theme) {
